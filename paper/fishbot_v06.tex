...
$\mathbf{+2.347}$ sets per game, declaring correctly $96.5\%$ against
$78.9\%$, once a bridge defect of ours worth $-0.08$ to them is repaired;
...
\paragraph{How much of the margin is that, exactly.} The paragraph above is a
...
\midrule
measured margin & --- & $+2.5000$ $[+2.2772, +2.7228]$ \\
their ownership-class errors & $0.650$/game & $+1.3000$ \\
their allocation-class errors & $0.268$/game & $+0.5367$ \\
our own wrong declarations & $0.150$/game & $-0.3000$ \\
\midrule
everything else & --- & $+0.9633$ $[+0.7375, +1.1892]$ \\
\bottomrule
\end{tabular}
\end{center}

\noindent \textbf{Sixty-one per cent of the margin is declaration
accounting.} The edge is real and it is sixfold --- we declare wrongly $0.150$
times a game against their $0.918$ --- but it is a \emph{declaration} edge, and
...
between them produce once the declarations are netted out, is $+0.963$ sets
per game: a real margin, and a little over a third of the headline one.
