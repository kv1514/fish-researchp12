...
$15.1\%$ two, $5.1\%$ three or more. \textbf{$8{,}626$ of $16{,}156$ --- $53.4\%$ --- carry at least one
derived card}, and the error rate falls from $0.046$ with none to $0.011$ with
one and $0.000$ with three. Deriving cards after the freeze is not a curiosity
at the margin; it is what makes a declaration safe, and it is the common case.
...
The retest matters because this is the only term in the basis that points at
...
hand has no split to name. It is registered at
\path{prereg/concentration_v2.md} at $4{,}000$ games, with arms at $0.60$ and
$1.50$ and with the mechanism (allocation errors falling, concentration at
declaration time rising) as a \emph{withdrawal condition} rather than a
secondary.
