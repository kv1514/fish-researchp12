...
\midrule
\texttt{dylan\_v07} & $4.150$ & $3.02$ & $0.896$ & $11.248$ & $11.248$ \\
\texttt{ev\_claim}  & $3.005$ & $1.65$ & $0.462$ & $2.285$  & $2.283$ \\
\texttt{search}     & $3.112$ & $1.64$ & $0.390$ & $1.992$  & $1.992$ \\
\texttt{memory}     & $2.770$ & $1.95$ & $0.421$ & $2.275$  & $2.277$ \\
\texttt{self}       & $1.030$ & $1.44$ & $0.423$ & $0.627$  & $0.627$ \\
\bottomrule
\end{tabular}
\end{center}

\noindent Against \texttt{ev\_claim} the dose ratio is $4.93$, and the three
terms contribute $1.38$, $1.84$ and $1.94$, whose product is $4.92$. No term
dominates, and the first one is not what it looks like: we enter the stuck
state \emph{less} often against \texttt{dylan\_v07} than against
\texttt{ev\_claim}, \texttt{search} or \texttt{memory} ($0.517$ episodes a
game against $0.703$, $0.733$ and $0.812$), and the whole of the opportunity
difference is that each episode lasts $1.87$ times longer. Board-wide
ambiguity is flat across all five at $24.5$ to $26.0$ cards, as is how often
their asks land on our seats, at $22.5$ to $27.9$, so it is not that this
opponent leaves our own hands less located.
...
against \texttt{dylan\_v07} $89.6\%$ of stuck turns clear that bar against
$39$ to $46\%$ everywhere else. When we cannot place a half-suit against this
opponent we usually have nothing worth asking anywhere either: the position is
more thoroughly exhausted, not merely more ambiguous.
