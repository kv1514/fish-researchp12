...
our arbiter, \emph{persistent} bridge & $-0.6900$ & $400$ \\
their arbiter, our bot package & $-0.6200$ & $1{,}200$ \\
\bottomrule
\end{tabular}
\end{center}

\noindent The two routes that do not reset their engine every decision agree to
within $0.07$ sets a game. The one that does is the outlier, by three.
