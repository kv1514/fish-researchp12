...
(\path{prereg/signal_no_repeat.md}, \path{results/signal_no_repeat.json}).
...
$+2.4395$ against $+2.4450$. The ninety-six percent of asks that carry no
information are the only thing buying the delay, and a mechanism whose value
survives none of its own repetition is not a communication protocol that
happens to stall; it is a stall that happens to communicate.
