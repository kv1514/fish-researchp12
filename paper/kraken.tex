...
\midrule
games & $10{,}000$ & $1{,}200$ \\
our margin (sets/game) & $\mathbf{+2.3466}$ & $\mathbf{-0.4600}$ \\
our games won & $80.41\%$ & $43.50\%$ $[40.75, 46.25]$ \\
our declaration accuracy & $96.49\%$ & $98.89\%$ \\
their declaration accuracy & $78.87\%$ & $98.43\%$ \\
\bottomrule
\end{tabular}
\end{center}
...
declaration accuracy, which moves by $19.6$ points between the two columns
while ours moves by $2.4$. Since $57\%$ of the $+2.3466$ is declaration
...
\texttt{-{}-no-out-of-turn} & $0.00$ & $\mathbf{0.0729}$ \\
...
what separates $0.073$ from $0.844$, and the caveat this paper has attached to
...
their error rate is the same as facing their own v0.6.
