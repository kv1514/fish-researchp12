...
% =====================================================================
\section{KRAKEN v1.1: seven directions, seven closures, nothing shipped}
\label{sec:v11}
...
\subsection{The discipline: a futility screen before a duel}
...
\subsection{Direction 6, closed by proof: an invariant of the possession search}
...
\subsection{Direction 4: the teammate ceiling is 46\% interaction}
...
\subsection{How much is actually left, measured with power}
...
\subsection{The one-step regret belongs to the turf, and the turf is the positions}
...
\subsection{The endgame ask correction does not survive the rule change}
...
\subsection{A correction to intervals published earlier in this paper}
