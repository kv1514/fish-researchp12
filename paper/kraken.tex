...
\textbf{v0.4 importance sampler, 512} & \textbf{1.3618} & 0.6955 & 0.403 & 92.3 \\
...
cards actually are. Lower NLL and Brier are better. Bold marks the three rows
the text turns on. The comparison that matters is the first two: the
