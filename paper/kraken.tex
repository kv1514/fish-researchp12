...
is convex rather than concave. Volume is not a cost the mechanism pays on the
way to something cheaper; it is the whole of what it buys, and there is no
inexpensive version of this protocol to find. Two registrations now say so from
opposite directions: suppressing repeats deletes the channel, and so does
rationing them.
...
and the single row with a channel is the only one that rises above it. The
