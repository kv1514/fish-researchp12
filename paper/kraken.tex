...
rate \emph{rise} in points predicts $+0.0423$, which is outside it. The
mechanism costs an opponent a roughly constant \emph{fraction} of the
declarations they were already getting wrong, so an opponent who misdeclares
half as often loses half as much to it.
