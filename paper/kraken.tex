...
at $21.8\%$, the next at $10.8\%$, and the rest between $3\%$ and $7\%$. The
...
every opponent in this registry except one has a baseline below $22\%$. The
two laws differ by less than $20\%$ at every error rate this study has
measured.

They separate in one place. \texttt{heuristic} misdeclares $72.5\%$ of the
time, three times \texttt{dylan\_v07}'s rate, and there the multiplicative law
predicts $+0.0426$ against the logistic law's $+0.0143$, a factor of $2.97$.
So the shape of the transfer is an open question with a sharp discriminating
test, and \path{prereg/signal_dose_law.md} registers it. Until that runs, what
is established is the negative half --- the effect is not additive in
percentage points --- and the positive half is stated as scaling with the
baseline without committing to which of the two scalings it is.
