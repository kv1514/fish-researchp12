...
A matched-dose design therefore cannot be built by choosing opponents. It
would have to hold fires a game fixed by construction --- the budget parameter
of \S\ref{sec:missing} caps a dose but cannot raise one --- and no opponent
in this registry other than \texttt{dylan\_v07} reaches the volume at which
the effect exists.
