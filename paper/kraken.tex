...
interval and withdraws one conclusion. Across the whole project, thirty-eight
...
engine's. This is measured but narrower than it looks: the two dialects differ
on out-of-turn declaration, which that project's own sweep shows moves its edge
by about half a percentage point, and it is one opponent rather than a
population.
...
all thirty-eight registrations this project has written are in
...
costs more than it looks: exactly one of the thirty-eight registrations
