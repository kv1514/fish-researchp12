...
%
% WHY THIS FILE EXISTS. The report is 142 pages. That length is defensible --
...
Forty-seven pre-registrations, written before the runs, each naming its
...
Since the correction, five pre-registered programmes (P43--P47, fourteen
