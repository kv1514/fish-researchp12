...
%
% WHY THIS FILE EXISTS. The report is 141 pages. That length is defensible --
...
Since the correction, four pre-registered programmes (P43--P46, fourteen
...
a metric is not necessarily one to close, now replicated. P46's one licensed
arm reads $+0.24$ / $+0.16$, positive in both populations, clear of zero in
neither; P47 confirms it.
