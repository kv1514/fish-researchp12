...
%
% WHY THIS FILE EXISTS. The report is 138 pages. That length is defensible --
...
Forty-six pre-registrations, written before the runs, each naming its
...
Since the correction, three pre-registered programmes (P43--P45, ten arms)
have tried to recover the deficit under a bar of $+0.15$ against their engine
...
a metric is not necessarily one to close, now replicated. A fourth, P46,
scores the belief itself and is registered and running.
