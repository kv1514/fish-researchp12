...
which the solver's opponent model is simply \emph{wrong} about --- over 400
paired deals:
\[
  +0.0750 \quad 95\%\text{ CI } [+0.0100, +0.1400]
\]
against $+0.0765$ for the champion it was built to answer. The same gain
...
null count moves the same way here too: 130 against 150.
