...
solved median of $4$. So both reported means are \emph{lower} bounds on
the gain over the whole layer, and $m = 2$'s is the looser of the two.

No corrected figure is offered. The slope is fitted over the supports the
solver reaches and the missing positions run to $60{,}480$ deals; extrapolating
across that would be inventing a number for the part of the layer nobody has
solved.
