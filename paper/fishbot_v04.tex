...
rather than with a cleverer proposal. Whether the policy can \emph{feel} it is a
duel and is not claimed here.
...
The mechanism is the one the term was built for, and it is now measured rather
than asserted. A player asks where they are deep only if they had a choice.
Early, holding nine cards across many live half-suits, they do; late, holding
two cards with most of the deck resolved, legality binds and they ask where they
\emph{can}.
...
\paragraph{What was changed, and what was not.} \texttt{gamma\_schedule} now
...
vertex because past there the parabola turns up and the measurements do not. It
