...
however much signal the target carries. It says the re-run needs a different
basis, or a penalty, or terms dropped, and not merely more rollouts. The whole
eleven-term fit explains $11.7\%$ of within-position variance, so there is signal
to work with; what there is not is a way to attribute it to individual terms as
