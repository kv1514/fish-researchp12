...
what the second factor does, and across the $28$ cells of this study that store
...
with nothing in common but the harness --- it barely moves: $3.88 \pm 0.23$, a
relative spread of $5.9\%$ against $9.6\%$ for the raw standard deviation. The
correlation between $s$ and the raw standard deviation is $+0.858$, and $+0.824$
with the single least-divergent cell removed, so it is not one point.
